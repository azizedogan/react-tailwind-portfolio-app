    ...
    <div name='contact' className='w-full h-full bg-[#0a192f] flex justify-center items-center pt-[10%]'>
        <form className='flex flex-col max-w-[600px] w-full'>
            <div className='pb-8'>
                ...
                <p className='text-gray-300 py-4'>// Submit the form below or shoot me an email - info@gmail.com
                </p>
            </div>
            <input className='p-2 bg-[#ccd6f6]' type="text" name='name' placeholder='Name' />
